extends "res://mods-unpacked/Snek-Phosphorescence/overwrites/content/weapons/obelisk/DamageManager.gd"
...
const EXPLOSION_GROUND = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/shared/explosions/Explosion98.tscn")
const EXPLOSION_AIR = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/shared/explosions/Explosion97.tscn")
const EXPLOSION_STUN = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/shared/explosions/Explosion96.tscn")
const EXPLOSION_SINGLE = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/shared/explosions/Explosion95.tscn")
const EXPLOSION_MARK = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/shared/explosions/Explosion94.tscn")
const LIGHTNING_DOWN = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/weapons/obelisk/LightningDown.tscn")
const MARK = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/weapons/obelisk/Mark.tscn")
const EXPLOSION_SNIPER = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/shared/explosions/Explosion93.tscn")

const SHOCK_MANAGER = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/weapons/obelisk/ObeliskShockManager.tscn")
const NUKE_ECHO = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/weapons/obelisk/DecayStunDoT.tscn")
