...
const HIT_MARKER = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/weapons/obelisk/HitMarker.tscn")
const KILL_MARKER = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/weapons/obelisk/KillMarker.tscn")
const SHOT_READY = preload("res://mods-unpacked/Snek-Phosphorescence/overwrites/content/weapons/obelisk/ShotReady.tscn")
